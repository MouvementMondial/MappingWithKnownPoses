...
def slatch(path,nrOfScans,bbPseudoRadius,l_occupied,l_free,l_min,l_max,resolution,stddPos,stddYaw,UID):
    #print('Start slatch')    
...
#try:
    for ii in range(0,nrOfScans+1):
        ...
        if ii != 0: # if it is not the first measurement
            ...
            Fit scan to map
            """
            estimatePose = posEstimation.fitScan2Map(grid,pointcloud,500,1,500,
...
def slatch2Resample(path,nrOfScans,bbPseudoRadius,l_occupied,l_free,l_min,l_max,resolution,stddPos,stddYaw,UID):
    #print('Start slatch')    
...
def slatchNoResample(path,nrOfScans,bbPseudoRadius,l_occupied,l_free,l_min,l_max,resolution,stddPos,stddYaw,UID):
    #print('Start slatch')    
