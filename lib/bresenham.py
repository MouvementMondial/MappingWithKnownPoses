...
def bresenham3D(startPoint, endPoint):
    ...
    steepXZ = (abs(endPoint[0,2] - startPoint[0,2]) > abs(endPoint[0,0] - startPoint[0,0]))
    if(steepXZ):
        startPoint[0,0], startPoint[0,2] = startPoint[0,2], startPoint[0,0]
        endPoint[0,0], endPoint[0,2] = endPoint[0,2], endPoint[0,0]

    delta = [abs(endPoint[0,0] - startPoint[0,0]), abs(endPoint[0,1] - startPoint[0,1]), abs(endPoint[0,2] - startPoint[0,2])]
    ...
    step = [
      -1 if startPoint[0,0] > endPoint[0,0] else 1,
      -1 if startPoint[0,1] > endPoint[0,1] else 1,
      -1 if startPoint[0,2] > endPoint[0,2] else 1
    ]
